...
def main(args):
    ...
    measurement = measurement[
        ['speed', 'cos_wind_dir', 'sin_wind_dir', 'temp', 'radiation', 'precip', 'season']]#, 'scenario', 'dangerous']]
    ...
    #_, _, _, y_scenarios = proc.prepare_x_y(measurement, forecast, steps_in, steps_out, 'scenario')
    ...
    if args.classification:
        ...
        lnr_scenarios.write_html("Trees/" + args.filename + "_Classification_tree_scenarios_in" + str(args.steps_in) + "_out" + str(args.steps_out) + "_criterion_" + str(args.class_criterion) + ".html")
        lnr_scenarios.write_json(
            "Trees/" + args.filename + "_Classification_tree_scenarios_in" + str(args.steps_in) + "_out" + str(
                args.steps_out) + "_criterion_" + str(args.class_criterion) + ".json")
        ...
        lnr_dangerous.write_html("Trees/" + args.filename + "_Classification_tree_dangerous_in" + str(args.steps_in) + "_out" + str(args.steps_out)+ "_criterion_" + str(args.class_criterion) +".html")
        ...
        if args.autobalance:
            ...
            lnr_scenarios_autobalance.write_html(
                "Trees/" + args.filename + "_Classification_tree_scenarios_autobalance_in" + str(args.steps_in) + "_out" + str(args.steps_out) + "_criterion_" + str(args.class_criterion) + ".html")
            lnr_scenarios_autobalance.write_json(
                "Trees/" + args.filename + "_Classification_tree_scenarios_autobalance_in" + str(
                    args.steps_in) + "_out" + str(args.steps_out) + "_criterion_" + str(args.class_criterion) + ".json")
            ...
            lnr_dangerous_autobalance.write_html(
                "Trees/" + args.filename + "_Classification_tree_dangerous_autobalance_in" + str(args.steps_in) + "_out" + str(args.steps_out) + "_criterion_" + str(args.class_criterion) +".html")
            ...
            print("\nClassification Based Scores Autobalance:")
            ...
            print("Classification based scenarios, F1 macro: ",
                  f1_score(y_test_scenarios, lnr_scenarios_autobalance.predict(X_test), average='macro'))

            print("Classification based dangerous, Accuracy: ",
