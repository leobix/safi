...
parser.add_argument("--t_list", type=int, nargs="+", default=[1,3,6,9,12,15,18,21,24,27,30,33,36,39,42,45,48],
...
if __name__ == "__main__":
    ...
    for t in t_list:
        print('training for predict t = ', t)
        #run model
        predict, true, base = run_xgb(steps_in=args.steps_in, steps_out=t, max_depth = args.max_depth, n_estimators = args.n_estimators)
        ...
        print('speed_mae, angle_mae, scenario_accu =', mae_speed, mae_angle, pred_scenario)
    #output results df
